...
class WomanIcon extends Component {
    render() { 
        return (
          <>
            <svg
              data-svgs-path="theme_dark/inbox_zero.svg"
              viewBox="0 0 220 200"
              ...
              <g transform="translate(-2050)">
                <g id="InboxZero">
                  ...
                  <path
                    ...
                    fill="#fff"
                    fillRule="nonzero"
                    transform="matrix(.89542 .03478 -.01862 .47945 -40.821 -1115.355)"
                  ></path>
                  <path
                    ...
                    fill="#fff"
                    fillRule="nonzero"
                    transform="matrix(1.42526 0 0 .76132 -1406.925 -1720.223)"
                  ></path>
                  <path
                  ...
                  ></path>
                  <path
                    d="M21138.1 1333.45c.9-.75 2.2.37 1.4 1.03-10.9 8.87-16.1 22.52-14.4 35.15 0 0-.4 1.56-1.5.88-.4-.24-.4-.8-.5-1.24-1.5-12.99 4-26.86 15-35.82z"
                    fill="#fff"
                    fillRule="nonzero"
                  ...
                  ></path>
                  <path
                    d="M2216.8 132.671c-2.54-2.193-4.01-4.672-3.27-5.534.74-.863 3.41.217 5.96 2.41-.25-3.352.47-6.142 1.6-6.227 1.13-.085 2.26 2.567 2.51 5.919 2.19-2.548 4.67-4.014 5.54-3.272.86.742-.22 3.412-2.42 5.96 3.36-.251 6.15.466 6.23 1.6.09 1.134-2.56 2.259-5.92 2.51 2.55 2.192 4.02 4.672 3.27 5.534-.74.862-3.41-.218-5.95-2.41.25 3.352-.47 6.142-1.61 6.227-1.13.085-2.25-2.567-2.5-5.919-2.2 2.548-4.68 4.014-5.54 3.272-.86-.742.22-3.413 2.41-5.96-3.35.251-6.14-.466-6.23-1.6-.08-1.134 2.57-2.259 5.92-2.51zm4.7-.265c1.2-.256 2.37.506 2.63 1.701a2.221 2.221 0 0 1-1.7 2.627 2.216 2.216 0 0 1-2.63-1.7 2.215 2.215 0 0 1 1.7-2.628z"
                    fill="#fff"
                    transform="translate(.005)"
                  ></path>
                  <g>
